...
public class BehaviorMecanim : MonoBehaviour
{
    ...
    public Node Node_ChooseNextShop()
    {
        return new LeafInvoke(
            () => this.Character.ChooseNextShop()
            );
    }
    ...
    {
        return new LeafInvoke(
            () => this.Character.NavGoToNextShop(),
            () => this.Character.NavStop());
    }

    public Node Node_LeaveShop()
    {
        return new LeafInvoke(
            () => this.Character.NavLeaveShop(),
            () => this.Character.NavStop());
    }
    ...
    public Node Node_OrientTowardsShop()
    {
        return new LeafInvoke(
            () => this.Character.NavTurnShop(),
            () => this.Character.NavOrientBehavior(
                OrientationBehavior.LookForward));
    }
    ...
    public Node Node_HeadLookBoth(Vector3 eyeHeight)
    {
        return new LeafInvoke(
                () => this.Character.HeadLookAtBoth(Val.V(() => eyeHeight)),
                () => this.Character.HeadLookStopBoth());
    }
    ...
    public Node Node_HandAnimationOther(Val<string> gestureName, Val<bool> start)
    {

        return new LeafInvoke(
            () => this.Character.HandAnimationOther(gestureName, start),
            () => this.Character.HandAnimationOther(gestureName, false));
    }
    ...
    public Node Node_SpeechBubbleOther(Val<string> message, Val<long> duration)
    {
        return new LeafInvoke(() => this.Character.DisplaySpeechBubbleOther(message.Value, duration.Value));
    }
    ...
    public Node ST_PlayHandGestureOther(
        Val<string> gestureName, Val<long> duration)
    {
        return new DecoratorCatch(
            () => this.Character.HandAnimationOther(gestureName, false),
            new Sequence(
                Node_HandAnimationOther(gestureName, true),
                new LeafWait(duration),
                Node_HandAnimationOther(gestureName, false)));
    }
    ...
    {
        return ST_PlayHandGesture(handGesture, duration);
        //return new SequenceParallel(ST_PlayHandGesture(handGesture, duration), Node_SpeechBubble(message, duration));
    }

    public Node ST_DisplaySpeechBubbleOther(
        Val<string> message, Val<string> handGesture, Val<long> duration)
    {
        return ST_PlayHandGestureOther(handGesture, duration);
        //return new SequenceParallel(ST_PlayHandGestureOther(handGesture, duration), Node_SpeechBubbleOther(message, duration));
    }
